...
cert_write request_file=srv_cert.req md=SHA256 issuer_key=ca_privkey.pem issuer_name=CN=$CA_CN,O=$ORG,C=CN output_file=srv_cert.pem not_before=20180101000000 not_after=20231231115959 serial=16012 > /dev/null
